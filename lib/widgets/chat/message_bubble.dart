...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isUserMessage = chatMessage.isUserMessage;
    ...
    return Row(
      ...
      children: <Widget>[
        Flexible( // Added Flexible here to ensure the bubble itself can flex
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text( // Removed Flexible from here as the parent Container and Row handle constraints
                    chatMessage.text,
