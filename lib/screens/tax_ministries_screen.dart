  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Ministerio>>(
        future: DatabaseService.instance.ministerioDao.getAll(langCode: currentLang),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (ministerios.isEmpty) {
              return const Center(child: Text('Aucun ministère trouvé.')); // Localization later
            }
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => TaxSectorsScreen(
                            ...
                            ministerioNombre: ministerioName, // ministerio.getNombre(currentLang) also works
                          ),
                        ),
                      );
                    },
            ...
            // But as a fallback:
            return const Center(child: Text('Aucun ministère disponible.')); // Localization later
          }
        },
      ),
    );
