  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Categoria>>(
        future: DatabaseService.instance.categoriaDao.getBySectorId(sectorId, langCode: currentLang),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (categorias.isEmpty) {
              return const Center(child: Text('Aucune catégorie trouvée pour ce secteur.')); // Localization later
            }
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => TaxSubCategoriesScreen(
                            ...
                            categoriaNombre: categoriaName, // categoria.getNombre(currentLang) also works
                          ),
                        ),
                      );
                    },
            ...
            return const Center(child: Text('Aucune catégorie disponible pour ce secteur.')); // Localization later
          }
        },
      ),
    );
