...
class TaxSubCategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String defaultSubCategoryName =
        "Taxes / Services Directs"; // Localization later
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<SubCategoria>>(
        future: DatabaseService()
            .subCategoriaDao
            .getByCategoriaId(categoriaId, langCode: currentLang),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (subCategorias.isEmpty) {
              return const Center(
                  child: Text(
                      'Aucune sous-catégorie trouvée pour cette catégorie.')); // Localization later
            }
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      final String? subCategoriaName =
                          subCategoria.getNombre(currentLang);
                      final String subCategoriaNombreDisplay = (subCategoriaName !=
                                  null &&
                              subCategoriaName.isNotEmpty)
                          ? subCategoriaName
            ...
            return const Center(
                child: Text(
                    'Aucune sous-catégorie disponible pour cette catégorie.')); // Localization later
          }
        },
      ),
    );
