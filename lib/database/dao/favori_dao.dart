...
class FavoriDao {
  ...
  Future<Favori?> getByConceptoId(String conceptoId) async {
    try {
      ...
      developer.log('Error getting favori by concepto id: $e',
          name: 'FavoriDao');
  ...
  Future<bool> isFavorite(String conceptoId) async {
    try {
      ...
      developer.log('Error checking if concept is favorite: $e',
          name: 'FavoriDao');
  ...
  Future<int> deleteByConceptoId(String conceptoId) async {
    try {
      ...
      developer.log('Error deleting favori by concepto id: $e',
          name: 'FavoriDao');
  ...
  Future<List<String>> getAllFavoriteConceptoIds() async {
    try {
      ...
      developer.log('Error getting all favorite concepto ids: $e',
          name: 'FavoriDao');
  ...
  Future<List<Favori>> getFavorisAddedAfter(DateTime date) async {
    try {
      ...
      developer.log('Error getting favoris added after date: $e',
          name: 'FavoriDao');
  ...
  Future<List<Favori>> getFavorisByMinisterioId(String ministerioId) async {
    try {
      ...
      final List<Map<String, dynamic>> maps =
          await _db.rawQuery(query, [ministerioId]);

      return maps.map((map) => Favori.fromMap(map)).toList();
    } catch (e) {
      developer.log('Error getting favoris by ministerio id: $e',
          name: 'FavoriDao');
  ...
  Future<Map<String, List<Favori>>> getFavorisGroupedByDate(
    ...
    try {
      ...
      developer.log('Error getting favoris grouped by date: $e',
          name: 'FavoriDao');
